...
/**
 * The parent route of every authenticated dashboard page, so the sidebar mounts once and survives
 * navigation instead of being torn down with each page.
 */
...
// The sidebar survives navigation, so nothing moves the focus: it stays on the link that was clicked and a
// screen reader never announces the page it opened.
